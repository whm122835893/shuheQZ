...
export const dashboardApi = {
  ...
  trends: (days?: number) => get('/dashboard/trends', { days: days || 7 }),
  priorityStats: () => get('/dashboard/priority-stats'),
}
...
export const collectibleApi = {
  ...
  forceSoldout: (id: number | string) =>
    put(`/collectibles/${id}/force-soldout`),
  destroy: (id: number | string, data: { userCollectibleId: number; userId: number; reason: string }) =>
    post(`/collectibles/${id}/destroy`, data),
  airdrop: (id: number | string, data: { activityId: number; userIds: number[]; quantity?: number }) =>
    post(`/collectibles/${id}/airdrop`, data),
  resaleToggle: (id: number | string) =>
    put(`/collectibles/${id}/resale-toggle`),
  priceControl: (id: number | string, data: { minResalePrice: number; maxResalePrice: number }) =>
    put(`/collectibles/${id}/price-control`, data),
  quotas: (id: number | string) =>
    get<InventoryQuota[]>(`/collectibles/${id}/quotas`),
  audit: (id: number | string, params: PaginationQuery = {}) =>
    get<PaginatedData<any>>(`/collectibles/${id}/audit`, params),
  createQualificationConfig: (id: number | string, data: { name: string; activityType?: string; rules?: Record<string, unknown> }) =>
    post(`/collectibles/${id}/qualification/config`, data),
  importQualificationWhitelist: (id: number | string, data: { configId: number; userIds: number[]; remark?: string }) =>
...
export const userApi = {
  ...
  resetTxPassword: (id: number | string) =>
    put(`/users/${id}/reset-tx-password`),
  forceLogout: (id: number | string) =>
...
export const categoryApi = {
  ...
  update: (id: number | string, data: { name?: string; sortOrder?: number }) =>
    put<any>(`/categories/${id}`, data),
  delete: (id: number | string) =>
    del(`/categories/${id}`),
...
export const orderApi = {
  ...
  markPaid: (id: number | string, data?: { paymentMethod?: string; remark?: string }) =>
    put(`/orders/${id}/mark-paid`, data),
  refund: (id: number | string, data: { reason: string; amount?: number }) =>
    post(`/orders/${id}/refund`, data),
  abnormal: (params: PaginationQuery = {}) =>
    get('/orders/abnormal/list', params),
}
...
export const marketingApi = {
  ...
  executeAirdrop: (id: number | string) =>
...
export const cmsApi = {
  ...
  createAnnouncement: (data: any) => post('/cms/announcements', data),
  updateAnnouncement: (id: number | string, data: any) =>
    put(`/cms/announcements/${id}`, data),
  togglePublishAnnouncement: (id: number | string) =>
...
export const securityApi = {
  ...
  blacklistAdd: (data: { type: number; target: string; reason?: string; expiredAt?: string }) =>
    post<Blacklist>('/security/blacklist', data),
