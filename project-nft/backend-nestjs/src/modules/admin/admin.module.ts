...
import { AdminSalePlanController } from './controllers/admin-sale-plan.controller';
...
import { SalePlanScheduleService } from './services/sale-plan-schedule.service';
...
@Module({
  ...
  providers: [
    ...
    AdminRewardService,
    AdminChainService,
    AdminSalePlanService,
    SalePlanScheduleService,
    AdminJwtStrategy,
  ],
