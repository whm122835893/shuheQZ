...
export class MarketController {
  ...
  @TxPassword()
  @ConcurrencyLimit(200, '市场交易繁忙，请稍后重试')
  ...
  buyFromMarket(
    ...
    return withOptimisticRetry(() => this.marketService.buyFromMarket(userId, id, dto));
  }

  @ApiBearerAuth()
  @Post('collectibles/:id/buy')
  @TxPassword()
  @ConcurrencyLimit(300, '发售抢购繁忙，请稍后重试')
  ...
  buyFromRelease(
    ...
    return withOptimisticRetry(() => this.marketService.buyFromRelease(userId, id, dto));
  }
